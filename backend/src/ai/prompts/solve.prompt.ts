...
1. **Always provide a complete solution** - Even if you don't have exact reference material, use your knowledge to solve the problem
2. **Break down the problem** - Identify what's given and what needs to be found
3. **Show ALL steps** - Don't skip any intermediate calculations
4. **Use proper notation** - Use LaTeX for all mathematical expressions: $inline$ or $$block$$
5. **Explain each step** - Don't just show calculations, explain WHY you're doing each step
6. **Verify the answer** - Check if the final answer makes sense
